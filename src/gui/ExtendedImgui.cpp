...
{
	ImGui::InputTextCallback_UserData* user_data = (ImGui::InputTextCallback_UserData*)data->UserData;
...
bool ImGui::InputText(const char *label, std::string& strRef, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void *user_data) {
...
bool ImGui::InputTextMultiline(const char *label, std::string& strRef, const ImVec2 &size, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void *user_data) {
	std::string* str = &strRef;
	IM_ASSERT((flags & ImGuiInputTextFlags_CallbackResize) == 0);
	   flags |= ImGuiInputTextFlags_CallbackResize;
